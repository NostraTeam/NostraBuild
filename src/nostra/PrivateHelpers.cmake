...
macro(_nostra_check_parameters)
    if(DEFINED FUNC_UNPARSED_ARGUMENTS)
        nostra_send_error("unknown argument \"${FUNC_UNPARSED_ARGUMENTS}\"")
    endif()
endmacro()
...
function(_nostra_check_no_parameters)
    if(ARGC GREATER 0)
        nostra_send_error("Unexpected parameters were passed to a function: ${ARGN}")
    endif()
endfunction()
...
macro(_nostra_check_if_nostra_project)
    ...
    if(NOT DEFINED PROJECT_PREFIX)
        nostra_send_error("PROJECT_PREFIX is not defined, has nostra_project() been called?")
    endif()
endmacro()
...
function(_nostra_check_if_lib TARGET)
    ...
    if(NOT "${NOSTRA_CMAKE_TARGET_TYPE}" MATCHES "(SHARED|STATIC)_LIBRARY")
        nostra_send_error("Target ${TARGET} is not a shared or static library.")
    endif()
endfunction()
...
function(_nostra_test)
    if(NOT ${ARGN})
        ...
        nostra_send_error("Test Failed: ${STR_OUT}")
    endif()
endfunction()
